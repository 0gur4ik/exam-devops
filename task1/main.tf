...
resource "digitalocean_vpc" "main_vpc" {
  name     = "andrus-vpc" # Назва: <Ваше прізвище>-vpc [cite: 6]
  region   = "fra1"       # Регіон: територіально найближчий до України 
  ip_range = "10.10.10.0/24" # Діапазон ІР-адрес: 10.10.10.0/24 [cite: 8]
}
